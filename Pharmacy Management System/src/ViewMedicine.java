...
public class ViewMedicine extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(786, 10, 30, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 80, 820, 317));
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 840, 430));
...
int a=JOptionPane.showConfirmDialog(null,"Do you want to delete this medicine?","Select",JOptionPane.YES_NO_OPTION);// TODO add your handling code here:
if(a==0)
    {
        try{
            Connection con=ConnectionProvider.getCon();
